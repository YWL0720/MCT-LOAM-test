...
void odom_estimation(){
    while(1){
        if(!pointCloudEdgeBuf.empty() && !pointCloudSurfBuf.empty()){
            ...
            Eigen::Quaterniond q_current(odomEstimation.odom_curr_middle.rotation());
            q_current.normalize();
            Eigen::Vector3d t_current = odomEstimation.odom_curr_middle.translation();
            ...
            laserOdometry.header.stamp.nsec = pointcloud_time.nsec + 50000;
